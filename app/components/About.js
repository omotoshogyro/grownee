...
useEffect(() => {
    ...
    else if (window.matchMedia("(min-width: 920px) and (max-width:1280px)").matches) {
    let trigger = ScrollTrigger.create({
  ...
  useEffect(() => {
      const pops = [pop1.current, pop2.current, pop3.current, specialRef.current, infoRef.current, buttonRef.current]
...
animateSection(sectFourth, fourthRef);
      ...
      const refs = [
          mobileref1.current,mobileref2.current,mobileref3.current,mobileref4.current, firstRef.current, secondref.current, thirdref.current, fourthRef.current
          ]
        refs.forEach((ref) => {
        gsap.fromTo(
          ref,
    ...
    <div className='about' ref={containerRef}>
        <div className='about__static' ref={stickyref}>
            <div className={`section`} >
              <div className={`box ${activeIndex === 0 ? "focus" : "not_focused"}`}>
                <div className="before" ref={sectFirst}></div>
                <h6>Invest smart without feeling lost</h6>
                <p>From fixed deposits to mutual funds, Grownee helps you invest with clarity.</p>
                </div>
            </div>
             <div className={`section`} >
              <div className={`box ${activeIndex === 1 ? "focus" : "not_focused"}`}>
                <div className="before" ref={sectSecond}></div>
                <h6>Budgeting That Understands Your Real Life.</h6>
                <p>Grownee helps you build a flexible budget you can actually stick to.</p>
                </div>
            </div>
            <div className={`section`}>
               <div className={`box ${activeIndex === 2 ? "focus" : "not_focused"}`}>
                <div className="before"  ref={sectThird}></div>
                <h6>Save with intention</h6>
                <p>Pick a plan, automate contributions, track daily interest, and pause anytime.</p>
                </div>
            </div>
               <div className={`section`} >
        ...
        <div className='about__dynamic' ref={dynamicref}>
            ...
            <div className={`content first ${activeIndex === 0 ? "inview" : "not_in_view"}`} ref={firstRef}>
                <div className='top'>
                    <div>
                        <p>Investment</p>
                ...
                <div className='info' ref={infoRef}>
                    <h6>23%</h6>
                    <p>Increase in the FMD stock as of today, take advantage of this trade and shine ya teeth!</p>
                </div>
            </div>
            ...
            <div className={`content second ${activeIndex === 1 ? "inview" : "not_in_view"}`} ref={secondref}>
                <div className='box'>
                    <CheckboxOutline/>
                    <p>Adobe Sub</p>
            ...
            <div className="mobile" ref={mobileref3}> 
              <h6>Save with intention</h6>
              <p>Pick a plan, automate contributions, track daily interest, and pause anytime.</p></div>
             <div className={`content third ${activeIndex === 2 ? "inview" : "not_in_view"}`} ref={thirdref}>
